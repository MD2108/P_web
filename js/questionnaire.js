...
/*         Questionnaire Title Functions              */
    ...
    function changeTitleName(id, Input) {
        ...
        if (!Input.value) {
            $.ajax({
                type: "POST",
                url: "../../Controller/Request/RequestC.php",
                data: ({
    ...
    function ActivateImageInput() {
        ...
        if (!ImageURL || ImageURL == "  ") {
            Input.value = "../assets/img/undefined.png";
        }
        else {
    ...
    function changeImage(id, Input) {
        ...
        else if (ImageURL != Input.value && Input.value != "../assets/img/undefined.png") {
            $.ajax({
                type: "POST",
                url: "../../Controller/Request/RequestC.php",
                data: ({
    ...
    function imageNotFound(Images, id) {
        ...
        Images.src = '../assets/img/undefined.png';
        Input.value = '../assets/img/undefined.png';
        $.ajax({
            type: "POST",
            url: "../../Controller/Request/RequestC.php",
