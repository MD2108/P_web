                    ...
                    <table id="datatablesSimple">
                        <thead>
                            <tr>
                                ...
                                <th id="author" onclick="sortTable(1, 'datatablesSimple')">User</th>
                                <th id="image" onclick="sortTable(2, 'datatablesSimple')">Score</th>
                                <th id="timer" onclick="sortTable(3, 'datatablesSimple')">Tries left</th>
                            </tr>
                        </thead>
                        <tfoot>
                            <tr>
                                <th id="questionnaire1" onclick="sortTable(0, 'datatablesSimple')">Questionnaire</th>
                                <th id="author1" onclick="sortTable(1, 'datatablesSimple')">User</th>
                                <th id="image1" onclick="sortTable(2, 'datatablesSimple')">Score</th>
                                <th id="timer1" onclick="sortTable(3, 'datatablesSimple')">Tries left</th>
                            </tr>
                        </tfoot>
                        <tbody>

                            <?php
                            foreach ($listeresults as $result) {
                                $user = $userC->getUser($result['idUser']);
                                $questionnaire = $questionnaireC->recupererQuestionnaire($result['idQuestionnaire']);
                            ?>

                                <tr>
                                    <td>
                                        <?php 
                                        if (isset($questionnaire['nomQuestionnaire'])) {
                                    ...
                                    <td><?php echo $result['numberTry'] ?></td>
                                </tr>
