<!DOCTYPE html>
<html class="no-js" data-darkreader-mode="dynamic" data-darkreader-scheme="dark" lang="zxx">
<head>
   ...
   <style class="darkreader darkreader--variables" media="screen">
      :root {
         --darkreader-neutral-background: #0d0f10;
         --darkreader-neutral-text: #d1cdc8;
         --darkreader-selection-background: #0046a3;
         --darkreader-selection-text: #e1dfdc;
      }
   </style>
   ...
   <style class="darkreader darkreader--user-agent" media="screen">
      ...
      select:-webkit-autofill {
         background-color: #4e5400 !important;
   ...
   <!-- Place favicon.ico in the root directory -->
      ...
      <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600" type="text/css">

   <meta name="darkreader" content="0313179721b1ef212bb7253413e30d21">
   <style class="darkreader darkreader--override" media="screen">
      .vimvixen-hint {
         background-color: #744d00 !important;
         border-color: #d1a90c !important;
         color: #ece1c1 !important;
      }
