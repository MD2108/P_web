<!doctype html>
<?php  $pageTitle= 'Index3allemni.tn'; 
       include "head.php" ; ?>
   <body>
  <?php include "preheader.php" ; include "header.php"?>
                           ...
                           <div class="hero__search">
                              <form action="#">
                                 <div class="hero__search-input mb-10">
                                    <input style=" background-color: rgb(249,250,251);" type="text" placeholder="What do you want to learn?">
                                    <button type="submit"><i class="fad fa-search"></i></button>
                                 </div>
                              </form>
                           ...
                           <div class="hero__thumb-2 scene">
                              ...
                              <div class="hero__class d-none d-lg-flex layer" data-depth="0.3">
                                 ...
                                 <div class="hero__class-text">
                                    ...
                                    <p>Tomorrow is our</p>
                                    <a href="front_register.php">Join Now</a>
                                 </div>
                              </div>
                              <div class="hero__mic">
                                 <span>
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="about__content pl-70 pr-60 pt-25">
                        <div class="section__title-wrapper mb-25">
                           <h2 class="section__title">Achieve your <br><span class="yellow-bg-big">Goals <img src="../assets/img/shape/yellow-bg-2.png" alt=""></span>  with 3allemni </h2>
                  ...
                  <div class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-6 col-md-8">
                     <div class="why__content pr-50 mt-40">
                        <div class="section__title-wrapper mb-30">
                           <span class="section__sub-title">Why Choses 3allemni</span>
                        ...
                        <div class="why__btn">
                           <a style="padding:0 150px;" href="front_register.php" class="e-btn e-btn-3 mr-30">Join US</a>
                           </a>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-xxl-2 offset-xxl-1 col-xl-2 offset-xl-1 col-lg-3 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
                     <div class="counter__item mb-30">
                        ...
                        <div class="counter__content">
                           <h4><span class="counter">421</span></h4>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-5">
                     <div class="counter__item counter__pl-80 mb-30">
                        ...
                        <div class="counter__content">
                           <h4><span class="counter">485</span></h4>
                           <p>Total Courses</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-2 offset-xxl-0 col-xl-3 offset-xl-0 col-lg-3 offset-lg-0 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
                     <div class="counter__item counter__pl-34 mb-30">
                        ...
                        <div class="counter__content">
                           <h4><span class="counter">2485</span></h4>
                           <p>Online Learners</p>
                        </div>
                     </div>
                  </div>
                                 ...
                                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="price__item grey-bg mb-30 p-relative">
                                       ...
                                       <div class="price__tag mb-25">
                                          <h4>49DT<span>.99 / annually</span></h4>
                                       </div>
                                       ...
                                       <a href="front_register.php" class="e-btn e-btn-4">Get Started</a>
                                    </div>
                                 </div>
                                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="price__item grey-bg mb-30 p-relative">
                                       ...
                                       <div class="price__tag mb-25">
                                          <h4>79DT<span>.99 / annually</span></h4>
                                       </div>
                                       <div class="price__features mb-40">
                                          <ul>
                                             <li><i class="far fa-check"></i>Course Discussions</li>
                                       ...
                                       <a href="front_register.php" class="e-btn e-btn-border">Get Started</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="row">
                                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="price__item grey-bg mb-30 p-relative">
                                       ...
                                       <div class="price__tag mb-25">
                                          <h4>499DT<span>.99 / annually</span></h4>
                                       </div>
                                       <div class="price__features mb-40">
                                          <ul>
                                             <li><i class="far fa-check"></i>Course Discussions</li>
                                 ...
                                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="price__item grey-bg mb-30 p-relative">
                                       ...
                                       <div class="price__tag mb-25">
                                          <h4>799DT<span>.99 / annually</span></h4>
                                       </div>
                                       <div class="price__features mb-40">
                                          <ul>
                                             <li><i class="far fa-check"></i>Course Discussions</li>
